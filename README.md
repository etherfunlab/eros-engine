...
```bash
docker pull ghcr.io/etherfunlab/eros-engine:1.3.1
...
docker run --rm -p 8080:8080 --env-file .env \
  ghcr.io/etherfunlab/eros-engine:1.3.1 serve
```
